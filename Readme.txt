...
🚦 Getting Started
    ...
    Bash
        ...
        1. git clone https://github.com/your-username/youtube-clone.git
        2. Run with a Local Server: Since the app uses fetch() to load dataset.json, you must run it through a server (like Live Server in VS Code) to avoid CORS policy restrictions.
        3. Persistence: Interact with the app! Your likes, subscriptions, and profile changes will remain even after you refresh the page.
